    ...
    <>
      ...
      <section className="relative overflow-hidden bg-[#1B3F8C]">
        ...
        <div className="relative mx-auto max-w-[1440px] px-4 py-24 md:px-6 md:py-32 xl:px-8 xl:py-40">
          ...
          <h4 className="mt-6 max-w-3xl text-4xl font-black leading-tight text-white sm:text-5xl md:text-6xl">
            Santé Globale des{' '}
            <span className="text-[#F4952F]">Copines</span>
          </h4>
          <p className="mt-6 max-w-2xl text-lg text-slate-100 md:text-xl">
           Projet d’accompagnement des  travailleuses de sexe dans  l ’amélioration de leur accès aux soins  
           de santé dans les régions du Centre, Littoral, Ouest et Sud du Cameroun
          </p>
