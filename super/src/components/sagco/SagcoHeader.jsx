...
const sagcoLinks = [
  ...
  { label: 'Actualités', to: '/sagco/actualites' },          // redirige vers le site principal
   { label: 'Réalisations', to: '/sagco/realisations' },   // ← local
  { label: 'Multimédia', to: '/sagco/multimedia' },        // idem (médiathèque)
