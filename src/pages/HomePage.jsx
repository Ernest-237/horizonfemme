...
export default function HomePage() {
  ...
  return (
    <div className="space-y-16 pb-8 md:space-y-20">
      ...
      {/* ════════════════════════════════════════════════════════════
          HERO — Image pleine largeur + texte EN BAS des visuels
          (compte rendu : "Positionner les textes en bas des visuels"
           + "Réduire la taille du header")
          ════════════════════════════════════════════════════════════ */}
      <section id="hero-home" className="relative w-full">
        <div className="relative overflow-hidden">

          {/* ── Images défilantes (slides) ── */}
          <div className="relative h-[52vh] min-h-[320px] md:h-[62vh] lg:h-[68vh]">
            ...
            {/* Overlay léger en bas pour la transition vers le texte */}
            ...
            {/* Indicateurs slides (dots) + compteur — EN BAS de l'image */}
            <div className="absolute bottom-5 left-1/2 z-10 flex -translate-x-1/2 items-center gap-6">
      ...
      {/* ════════════════════════════════════════════════════════════
          EDITO
          (compte rendu : "Remplacer le titre actuel du texte de l'édito"
           → titre = "Message de la Présidente" au lieu de "Message institutionnel")
          ════════════════════════════════════════════════════════════ */}
      <section id="edito-home" className="mx-auto max-w-7xl px-4 md:px-6 lg:px-8">
        <div className="grid gap-8 lg:grid-cols-[0.88fr_1.12fr]">
          ...
          <div className="rounded-[30px] border border-slate-200 bg-white p-7 shadow-sm md:p-8">
            ...
            {/* ↓ Titre changé : "Message de la Présidente" (compte rendu p.3) */}
      ...
      {/* ════════════════════════════════════════════════════════════
          ...
          (compte rendu p.3 : "Supprimer la section Nos initiatives")
          ════════════════════════════════════════════════════════════ */}
